...
## What is Equilibre
- [Equilibre Smart Contracts](https://github.com/andrecronje/solidly)
...
- [Equilibre: preparation for launch](https://andrecronje.medium.com/solidly-preparation-for-launch-8e653ce8a428)
...
- Copy any of the .env.{mainnet|testnet|local} to .env in order to connect website to RPC
- You can now run the nextjs app this way: `npm run dev` or `yarn dev`
